...
module BurnUnit
  class NewGameFormTest < ActiveSupport::TestCase
    ...
    test "#valid? returns true with minimum length inputs" do
    ...
    test "#valid? returns true with maximum length inputs" do
      form = NewGameForm.new(player_name: "a" * 25, question: "a" * 160)
    ...
    test "#valid? returns false with player name too short" do
      ...
      assert form.errors.added?(:player_name, message:
    ...
    test "#valid? returns false with both inputs invalid" do
