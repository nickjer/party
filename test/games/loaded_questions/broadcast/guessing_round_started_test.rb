...
module LoadedQuestions
  module Broadcast
    class GuessingRoundStartedTest < ActiveSupport::TestCase
      ...
      test "#call broadcasts to online non-guesser players" do
        ...
        assert_turbo_stream_broadcasts non_guesser, count: 1 do
          GuessingRoundStarted.new(game:).call
        end
      end
      ...
      test "#call broadcasts to multiple online non-guesser players" do
        ...
        assert_turbo_stream_broadcasts non_guessers.first, count: 1 do
