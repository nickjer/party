...
module BurnUnit
  module Broadcast
    class VoteCreatedTest < ActiveSupport::TestCase
      ...
      test "#call does not broadcast to offline players" do
        ...
        # Alice creating vote should not broadcast to offline Bob
